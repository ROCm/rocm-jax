...
JAX_DIR="./jax"
JAX_VERSION="0.7.1"
WHEELHOUSE="/dockerx/rocm/rocm-jax/wheelhouse"
PYTHON=3.12
...
if ! grep -q jax_rocm7 build/requirements.in; then
    {
        echo "jaxlib==0.7.1"
        echo "${WHEELHOUSE}/jax_rocm7_pjrt-0.7.1-py3-none-manylinux_2_28_x86_64.whl"
        echo "${WHEELHOUSE}/jax_rocm7_plugin-0.7.1-cp312-cp312-manylinux_2_28_x86_64.whl"
