...
EPILOG = """
From the root directory of the umbrella repository, run
  ...
  E.g. python build/build.py build --wheels=jax-rocm-plugin,jax-rocm-pjrt
...
# Updated for umbrella repository - use @jax_rocm_plugin references
WHEEL_BUILD_TARGET_DICT = {
    "jax-rocm-plugin": "@jax_rocm_plugin//jaxlib_ext/tools:build_gpu_kernels_wheel",
    "jax-rocm-pjrt": "@jax_rocm_plugin//pjrt/tools:build_gpu_plugin_wheel",
}
...
async def main():
    ...
    if args.command == "requirements_update":
        ...
        if args.nightly_update:
            ...
            # Updated for umbrella repository - use root build target
